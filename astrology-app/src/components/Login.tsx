        ...
        <div className="logo-container float">
          <div className="logo">
            <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M60 15 L75 45 L110 45 L82.5 67.5 L95 97.5 L60 75 L25 97.5 L37.5 67.5 L10 45 L45 45 Z" 
                    stroke="white" strokeWidth="2" fill="none"/>
              <text x="60" y="65" textAnchor="middle" fill="white" fontSize="24" fontWeight="bold">A</text>
            </svg>
          </div>
          <h1 className="app-title">Deepsoul</h1>
        </div>
