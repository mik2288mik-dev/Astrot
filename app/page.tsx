      ...
      <RouteTransition routeKey="home">
        <div>
          <section className="glass p-6">
            ...
            <Tap className="mt-4 w-full h-12 rounded-md pastel-gradient text-[#0A0A12] font-semibold shadow-card focus:outline-none focus-visible:shadow-focus">Открыть полную карту</Tap>
          </section>
